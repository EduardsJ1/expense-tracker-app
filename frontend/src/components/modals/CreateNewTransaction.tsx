...
import type {createTransactionType} from "../../types/transactions";
import { useAuth } from "../../hooks/useAuth";

function NewTransactionModal({display,closeModal,onTransactionCreate}:{display:boolean,closeModal:()=>void,onTransactionCreate:()=>void}){
    const {user}=useAuth();
        ...
        <div className={`fixed inset-0 z-50 flex items-center justify-center backdrop-blur-xs `}>
            <div className="bg-white p-6 rounded-lg shadow-lg w-3xl mx-12">
                <div className="relative">
                    <h2 className="text-xl font-bold text-center">Create new Transaction</h2>
                ...
                <form className="" onSubmit={handleSumbit}>
                    ...
                    <div className="flex justify-center space-x-5 pt-5">
                        <button type="submit" className="hover:cursor-pointer bg-green-600 rounded-2xl px-3 py-0.5 font-medium text-white hover:bg-green-700">Create</button>
